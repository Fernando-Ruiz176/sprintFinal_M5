...
// [ ] Implementa la funcionalidad de carga de imágenes utilizando la biblioteca Glide (opcional). Esto te permitirá cargar las imágenes de los zapatos desde una URL y mostrarlas en la lista.
// [ ] Puedes implementar esta pantalla utilizando un fragmento en Android Studio. El fragmento se encargará de mostrar la lista de productos en la pantalla de inicio.
// [ ] Recuerda que los productos deben ser una lista estática local, lo que significa que los datos de los zapatos y sus imágenes se encuentran predefinidos en el código de la aplicación. Puedes crear una clase de datos o utilizar una lista de objetos para almacenar la información de los zapatos.
